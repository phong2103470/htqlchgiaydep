...
{
    public partial class FormQuanLy_KH_NV : Form
    {
        SqlConnection conn = new SqlConnection();
        Ham func = new Ham();
        SqlCommand cmd = new SqlCommand();
        public FormQuanLy_KH_NV()
        {
            InitializeComponent();
        ...
        private void FormQuanLy_KH_NV_Load(object sender, EventArgs e)
        {
            func.KetNoi(conn);
        ...
        private void button6_Click_1(object sender, EventArgs e)
        {
            ...
            string sql = "update KHACH_HANG set hotenkh = N'" + textBox2.Text + "',ngaysinh = '" + dateTimePicker1.Value + "', gioitinh = N'" + gioiTinh + "', diachi = N'" + textBox4.Text + "', sdt = '" + textBox3.Text + "' where makh = '" + textBox1.Text + "'";
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            string sql = "insert into KHACH_HANG values ('" + textBox1.Text + "',N'" + textBox2.Text + "','" + dateTimePicker1.Value + "', N'" + gioiTinh + "',N'" + textBox4.Text + "','" + textBox3.Text + "')";
            SqlCommand comd_them = new SqlCommand(sql, conn);
            comd_them.ExecuteNonQuery();
        ...
        {
            if (dateTimePicker1.Value.Date > DateTime.Now || dateTimePicker1.Value.Date < new DateTime(2024, 1, 1))
            {
                MessageBox.Show("Không thể chọn ngày lớn hơn hôm nay hoặc năm nhỏ hơn 2024");
            }
        }
